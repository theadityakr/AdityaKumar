...
const Background = () => {
    ...
    const { theme, toggleTheme ,monospaced, toggleMonospace} = useContext(ThemeContext);
        ...
        function NeuralNetwork() {
            ...
            useEffect(() => {
                ...
                groupRef.current.scale.set(2.5, 2.5, 2.5); // Make the sphere larger
                groupRef.current.position.set(-11, 0, 0);
    ...
    return (
        <div id = 'Background' >
            {/* <canvas data-engine="three.js r161" ></canvas> */}
            <Canvas camera={{ position: [-13, 30, 17.5] }}>
                <NeuralNetwork />
                <OrbitControls />
            </Canvas>
        </div>
